    ...
    function Scroller(elem, settings) {
        ...
        */
        that.show = function (prevAnim) {
            ...
            var html = '<div class="dw-trans ' + s.theme + ' dw-' + s.display + '">' + (s.display == 'inline' ? '<div class="dw dwbg dwi"><div class="dwwr">' : '<div class="dw-persp">' + '<div class="dw dwbg ' + mAnim + '"><div class="dwwr">' + (s.headerText ? '' : ''));
            ...
            html += (s.display != 'inline' ? '<div class="dwbc' + (s.button3 ? ' dwbc-p' : '') + '"><span class="dwbw dwb-s" ><span class="dwb "  style="color: #c59721;">' + s.setText + '</span></span>' + (s.button3 ? '<span class="dwbw dwb-n"></span>' : '') + '<span class="dwbw dwb-c"><span class="dwb " id="dateCancel" style="text-align:left;">' + s.cancelText + '</span></span></div></div>' : '<div class="dwcc"></div>') + '</div></div></div>';
            dw = $(html);
